...
namespace FULLSTACKFURY.EduSpace.API.Migrations
{
    ...
    [Migration("20260620044613_ReconcileSharedAreaAndSensorAlignment")]
    partial class ReconcileSharedAreaAndSensorAlignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FULLSTACKFURY.EduSpace.API.IAM.Domain.Model.Aggregates.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("AccountId")
                        .HasDatabaseName("i_x_password_reset_tokens_account_id");
            ...
            modelBuilder.Entity("FULLSTACKFURY.EduSpace.API.IAM.Domain.Model.Aggregates.PasswordResetToken", b =>
                {
                    b.HasOne("FULLSTACKFURY.EduSpace.API.IAM.Domain.Model.Aggregates.Account", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_password_reset_tokens_accounts_account_id");
                });
